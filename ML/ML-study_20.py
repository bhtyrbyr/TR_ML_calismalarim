...
SVM1 = SVC(kernel='rbf')
SVM2 = SVC(kernel='poly', degree=1)
SVM3 = SVC(kernel='linear')
SVM1.fit(X_train,y_train)
SVM2.fit(X_train,y_train)
SVM3.fit(X_train,y_train)

y_svm1_pred = SVM1.predict(X_test)
y_svm2_pred = SVM2.predict(X_test)
y_svm3_pred = SVM3.predict(X_test)

print("------------------- SVM -------------------")
print(y_test.reshape(-1,1))
print("cm1\n",y_svm1_pred)
cm1 = confusion_matrix(y_test, y_svm1_pred)
print(cm1)
print("cm2\n",y_svm2_pred)
cm2 = confusion_matrix(y_test, y_svm2_pred)
print(cm2)
print("cm3\n",y_svm3_pred)
cm3 = confusion_matrix(y_test, y_svm3_pred)
print(cm3)
